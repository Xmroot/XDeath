...
package me.rick.xms.api.bstats.bukkit;
...
import me.rick.xms.api.bstats.MetricsBase;
...
public class Metrics {
    ...
    public Metrics(JavaPlugin plugin, int serviceId) {
        ...
        Consumer var10009 = (submitDataTask) -> {
            Bukkit.getScheduler().runTask((Plugin) plugin, (Runnable) submitDataTask);
        };
    ...
    private void appendServiceData(Object o) {
    }

    private void appendPlatformData(Object o) {
    }
